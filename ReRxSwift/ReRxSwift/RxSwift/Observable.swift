...
public class Observable<Element>: ObservableType {
    ...
    public func subscribe<Observer : ObserverType>(observer: Observer) -> Disposable where Observer.Element == Element {
...
extension ObservableType {
    public func subscribe(onNext: @escaping (Element) -> Void) -> Disposable {
    ...
    public static func just(_ value: Element) -> Observable<Element> {
    ...
    public func flatMap<U>(_ transfrom: @escaping (Element) -> Observable<U>) -> Observable<U> {
        return Observable({ (observer) -> Disposable in
            return self.subscribe(observer: Observer { (event) in
